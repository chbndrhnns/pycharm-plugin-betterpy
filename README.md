...
#### Parameter & Argument
- **Assign statement to variable** - Assigns a statement expression to a new local variable
...
#### Filters & Suppressors
- **Type annotation usage filtering** ([PY-56092](https://youtrack.jetbrains.com/issue/PY-56092)) - Filters out type annotation usages from Find Usages results
